...
Describe 'Get-SWPerson' -Tag 'Unit' {
    ...
    It $itName -TestCases @(
        # Arrange
        @{name = 'maul'; fullName = 'Darth Maul'; gender = 'male'
          eyeColour = 'yellow'; homeWorld = 'Dathomir'; filmCount = 1 }
        @{name = 'luke'; fullName = 'Luke Skywalker'; gender = 'male'
          eyeColour = 'blue'; homeWorld = 'Tatooine'; filmCount = 4 }
        @{name = 'mothma'; fullName = 'Mon Mothma'; gender = 'female'
          eyeColour = 'blue'; homeWorld = 'Chandrila'; filmCount = 1 }
        )  {
        # Act
